...
const News = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-10 w-11/12 lg:w-11/12 xl:w-8/12 mb-24 lg:mb-50'>
      <div className="w-full text-left md:text-[3rem] text-3xl mt-10 font-semibold">News & Updates</div>
      ...
      {!loading && newsList.length > 0 && 
        <div className="grid md:grid-cols-3 md:items-end w-full gap-10">
          {newsList?.map((post) => (
